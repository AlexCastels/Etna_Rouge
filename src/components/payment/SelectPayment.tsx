...
export function SelectPayment(){
  ...
  <form onSubmit={handleSubmint} className="selectPayment-container">
    <p className="selectPayment-title">
      <FormattedMessage id="selectPayment.title" defaultMessage="Payment Methods" />
    </p>
      ...
      <div className="selectPayform-creditCard-container">
        <div>
          ...
          <label htmlFor="credit-card">
            <FormattedMessage id="selectPayment.label.creditCard" defaultMessage="Credit Card" />
          </label>
        </div>
        <img className="selectPayform-img" src="/assets/Credit-Card.png" alt="Pagamenti accettati" />
      </div>
      <div className="selectPayform-delivery-container">
        <div>
          ...
          <label htmlFor="spedizione">
            <FormattedMessage id="selectPayment.label.cash" defaultMessage="Cash on Delivery" />
          </label>
        </div>
        <p>
          <FormattedMessage
    ...
    {notSelect && (
      <p className="selectPayform-notSelect">
        <FormattedMessage id="selectPayment.noSelected" defaultMessage="Please select a payment method" />
      </p>
    )}
    <div className="select-payform-line"></div>
    <button onClick={() => handleBtn(spia)}>
      <FormattedMessage id="selectPayment.button.checkout" defaultMessage="CHECKOUT" />
    </button>
  </form>
);
}